...
//
//   let getHistoryModel = try? newJSONDecoder().decode(GetHistoryModel.self, from: jsonData)

import Foundation

// MARK: - GetHistoryModel
struct GetHistoryModel: Codable {
    var status: Int?
    var message: String?
    var data: HistoryDataClass?
}

// MARK: - DataClass
struct HistoryDataClass: Codable {
    var post, pickup: Pickup?
    var postPickup: PostPickup?
}

// MARK: - Pickup
struct Pickup: Codable {
    var match, unMatch: [MatchElement]?
}
...
struct MatchElement: Codable {
    ...
    var days: String?
    var departments, date, startTime: String?
...
// MARK: - PostPickup
struct PostPickup: Codable {
    var match: PostPickupMatch?
    var unMatch: [JSONAny]?
}

// MARK: - PostPickupMatch
struct PostPickupMatch: Codable {
    var trade0, trade1, trade2: [JSONAny]?
}

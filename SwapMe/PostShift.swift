...
//  SwapMe
//
//  Created by Mr. Nabeel on 12/4/19.
...
class PostShiftViewController: UIViewController,UITextFieldDelegate {
    ...
    let menubtn = UI2()
    let heading = UI2()
    let notificationbtn = UI2()
    
    //for content
    let body = UI2()
    let one = UI2()
    let onelabel = UI2()
    let check = UI2(), datepicker = UI2(),daypicker = UI2()
    let day = [UI2(),UI2(),UI2(),UI2(),UI2(),UI2(),UI2()]
    let dayname = ["M","T","W","T","F","S","S"]
    var daynameSelect = [false,false,false,false,false,false,false]
    let line1 = UI2()
    let department = UI2(), departmentlabel = UI2()
    let line2 = UI2()
    let three = UI2()
    let threelabel = UI2()
    let two = UI2()
    let twolabel = UI2()
    let starttime = UI2(), starttimeTrue = UI2(), starttimeFalse = UI2(), starttimeTruelabel = [UI2(),UI2(),UI2(),UI2(),UI2()], starttimeFalselabel = [UI2(),UI2()]
    let starttimepicker = UI2(), starttimelabel = UI2(), starttimebutton = [UI2(),UI2()]
    var starttimeRadios:[Int:Bool] = [1:false,2:false,3:false,4:false]
    let endtime = UI2(), endtimeTrue = UI2(), endtimeFalse = UI2(), endtimeTruelabel = [UI2(),UI2(),UI2(),UI2(),UI2()], endtimeFalselabel = [UI2(),UI2()]
 ...
 self.GetDepartmentApi()
        ...
        checkboxonClick2.function = selectDate_or_Day_Change
        ...
        radiobuttonClick2.startTimefunction = startTimeRadiobuttonUpdater
        ...
        radiobuttonClick2.endTimefunction = endTimeRadiobuttonUpdater
...
//        self.navigationController?.popViewController(animated: true)
    ...
    @objc func continueButton(_ btn:UIButton){
        ...
        //////// validation start
        print("-----------")
        print(checkboxonClick2.isChecked) // bool
    ...
    func validation() -> Bool {
        ...
        var toastmessage = ""
        resetPostShiftvar()
        if checkboxonClick2.isChecked == true {
            PostShiftvar.Static.permanent = checkboxonClick2.isChecked
            var selected = false
            var index = 0
        ...
        else if checkboxonClick2.isChecked == false {
            PostShiftvar.Static.permanent = checkboxonClick2.isChecked
        ...
        else{PostShiftvar.Static.deleteShiftdays = Int(deleteShift.txtfield.text!)!}
    ...
    func selectDate_or_Day_Change() {
        print("checkbox: \(checkboxonClick2.isChecked)")
        if checkboxonClick2.isChecked {
    ...
    func onClickLayoutUpdater() {
        ...
        else{deleteShift.view.frame.origin.y = endtimeTrue.view.frame.maxY+10}
...
class checkboxonClick2 {
    static var function:()->() = {}
    static var isChecked:Bool = false
}
class radiobuttonClick2 {
...
class UI2: UIView {
    ...
    ////////////////////////////////////////////////
    // dependent on class 'checkboxonClick2'
    ...
    @objc func checkboxClick(_btn:UIButton){
        if checkboxonClick2.isChecked == true {
            ...
            checkbox.setBackgroundImage(UIImage(named: "checkboxTrue"), for: .normal)
            checkboxonClick2.isChecked=true
        }
        checkboxonClick2.function()
    }
...
//            datePicker.locale = Locale(identifier: "en_US")
    ...
    @objc func radioButtonClick(_ btn:UIButton){
        ...
        if btn.tag == 1 {radiobuttonClick2.startTimefunction()}
        if btn.tag == 2 {radiobuttonClick2.endTimefunction()}
    }
